...
- [ ] **Fretboard Grid:** Build a `<Fretboard />` component mapping over string arrays to render a responsive 0-24 fret grid.
- [ ] **Data Binding:** Connect the UI grid to the Rust engine to display correct note names based on fret and string coordinates.
